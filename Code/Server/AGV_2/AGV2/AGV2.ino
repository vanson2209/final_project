  ...
  if (mySerial.available()){
    ...
    switch (receivedChar) {
      case '0':
        ...
        break;
      case '1':
        webSocket.sendTXT("2S9Starting");
        break;
      case '2':
        webSocket.sendTXT("2S9Coming home");
        break;
      case '3':
        webSocket.sendTXT("2S9Going to the RP");
        break;
      case '4':
        webSocket.sendTXT("2S9Coming Back");
        break;
      case '5':
        ...
        break;  
      case '7':
        webSocket.sendTXT("2S9Sampling");
        break;
      case '8':
        webSocket.sendTXT("2S0Picking Up");
        break;
      case '9':
        webSocket.sendTXT("2S1Picking Up");
        break;
      case 'A':
        webSocket.sendTXT("2S2Putting Down");
        break;
      case 'B':
        webSocket.sendTXT("2S3Putting Down");
        break;
      case 'C':
        webSocket.sendTXT("2S4Putting Down");
        break;
      case 'D':
        webSocket.sendTXT("2S5Putting Down");
        break;
    }
  }
  receivedChar = 'X';
